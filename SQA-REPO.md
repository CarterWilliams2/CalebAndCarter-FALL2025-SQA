...
For continuous integration, we implement Codacy as we did in an earlier workshop. We set it up to run on every push. The build location is under the "actions" section of the repository and comes from the codacy.yml file in the .github/workflows/ directory of the repository.
